...
def build_demo_training_data():
    return [
        ...
        ('what can you do', 'I can help download TikTok videos, upload them privately to YouTube, and answer simple chat questions.'),
        ...
        ('how do i upload a video', 'Connect YouTube from the menu, then choose Upload to YouTube and send a TikTok link.'),
